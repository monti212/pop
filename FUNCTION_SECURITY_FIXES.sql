/*
  # Function Security Fixes - Search Path Vulnerabilities

  This file fixes all functions with mutable search_path security issues.
  Run these commands in your Supabase SQL Editor.

  ## What this fixes:
  Functions with role mutable search_path are vulnerable to search_path attacks.
  We fix this by setting a fixed search_path on each function.
*/
