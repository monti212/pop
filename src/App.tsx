...
const UsageIntelligence = lazy(() => import('./pages/UsageIntelligence'));
    ...
    <ConversationProvider>
      <Routes>
        ...
        <Route element={<SupaAdminRoute />}>
          {/* Cost breakdown exposes internal cost/margin data — supa_admin only,
              now that client-team (prime) accounts can reach /admin pages. */}
          ...
          <Route path="/supa-admin/token-usage" element={<Suspense fallback={<div className="min-h-screen bg-sand-200 flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-teal"></div></div>}><TokenUsage /></Suspense>} />
          ...
          <Route path="/supa-admin/usage-intelligence" element={<Suspense fallback={<div className="min-h-screen flex items-center justify-center" style={{ background: '#F1ECE2' }}><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-teal"></div></div>}><UsageIntelligence /></Suspense>} />
        </Route>
