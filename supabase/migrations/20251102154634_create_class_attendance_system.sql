/*
  # Create Class Attendance Management System

  ## Summary
  Creates a comprehensive attendance tracking system for teachers with enforced limits:
  - Maximum 5 classes per teacher account
  - Maximum 35 students per class
  - Student neurodivergence tracking for accommodations
  - Daily attendance records with flexible date selection
  - Admin monitoring capabilities for attendance compliance

  ## New Tables

  1. **classes**
     - Teacher's classroom groups (max 5 per teacher)
     - Class name, subject, grade level, schedule information
     - Student count tracking
     - Active status for archiving

  2. **students**
     - Student roster per class (max 35 per class)
     - Basic student information (name, identifier)
     - Neurodivergence status and type
     - Accommodations and learning notes
     - Active status

  3. **attendance_records**
     - Daily attendance tracking per student
     - Present/absent status
     - Date flexibility for recording
     - Audit trail with timestamps

  4. **attendance_summary**
     - Materialized view for quick statistics
     - Per-class and per-student attendance rates
     - Date range summaries

  ## Security
  - RLS enabled on all tables
  - Teachers can only access their own classes and students
  - Teachers can only record attendance for their students
  - Admins can view all records for monitoring
  - Database-level constraints enforce limits

  ## Constraints
  - Trigger to prevent more than 5 classes per teacher
  - Trigger to prevent more than 35 students per class
...
-- ============================================================================
-- 4. CONSTRAINT FUNCTIONS AND TRIGGERS
-- ============================================================================
...
-- ============================================================================
-- 6. HELPER FUNCTIONS FOR STATISTICS
-- ============================================================================
